 ...
 */
public abstract class ExtendableListView1 extends AbsListView {
    ...
    public ExtendableListView1(final Context context, final AttributeSet attrs, final int defStyle) {
    ...
    protected void onChange_Layout(final boolean changed, final int l, final int t, final int r, final int b) {
...
//            case TOUCH_MODE_OVERSCROLL:
    ...
    private void updateEmptyStatus() {
        ...
        if (empty) {
            ...
            if (mDataChanged) {
                this.onChange_Layout(false, getLeft(), getTop(), getRight(), getBottom());
            }
        }
        else {
            if (emptyView != null) {
    ...
    class AdapterDataSetObserver extends DataSetObserver {
        ...
        public void onChanged() {
            ...
            if (ExtendableListView1.this.getAdapter().hasStableIds() && mInstanceState != null
                    && mOldItemCount == 0 && mItemCount > 0) {
                ExtendableListView1.this.onRestoreInstanceState(mInstanceState);
                mInstanceState = null;
            }
            else {
                rememberSyncState();
        ...
        public void onInvalidated() {
            ...
            if (ExtendableListView1.this.getAdapter().hasStableIds()) {
                // Remember the current state for the case where our hosting activity is being
                // stopped and later restarted
                mInstanceState = ExtendableListView1.this.onSaveInstanceState();
            }
    ...
    private boolean performLongPress(final View child,
        ...
        if (onItemLongClickListener != null) {
            handled = onItemLongClickListener.onItemLongClick(ExtendableListView1.this, child,
