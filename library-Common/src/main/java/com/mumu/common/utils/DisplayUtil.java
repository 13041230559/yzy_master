...
public class DisplayUtil {
	...
	public static void setWidgetHeight(View view, int height){
		...
		view.setLayoutParams(params);
		Log.e("setWidgetHeight",height+"");
		Log.e("getWidgetHeight",getWidgetHeight(view)+"");
	}
	 ...
	 * @param height
	 */
	public static void setWidgetHeight_R(View view, int height){
	 ...
	 * @param height
	 */
	public static void setWidgetHeight_F(View view, int height){
