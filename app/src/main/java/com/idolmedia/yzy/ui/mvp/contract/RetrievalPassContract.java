 ...
 * 创建人：JOKER.WANG
 * 创建时间：2017/11/27 14:39
 * 描述：
 */

public interface RetrievalPassContract {

    interface Model extends BaseModel {
        Observable<BaseResult> RetrievalPass_m(HashMap<String, Object> map);
        Observable<BaseResult> Code_m(HashMap<String,Object> map);
    }
    interface View extends BaseView {
        void RetrievalPass_v(BaseResult t);
        void Code_v(BaseResult t);
    }
    abstract  class Presenter extends BasePresenter<View,Model> {
        public abstract void RetrievalPass_p(HashMap<String,Object> map);
