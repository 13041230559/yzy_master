...
public class PopDownWindow extends PopupWindow implements PopWindowInterface, View.OnClickListener,
    ...
    public PopDownWindow(Activity activity, CharSequence title, CharSequence message, PopWindow popWindow) {
        ...
        mPopWindowLayout = inflater.inflate(R.layout.tan_chuang_si, null);
    ...
    private void initAnim() {
        ...
        mAlphaOpenAnimation = AnimationUtils.loadAnimation(mActivity, R.anim.tanchuangqi);
        mAlphaCloseAnimation = AnimationUtils.loadAnimation(mActivity, R.anim.tanchuangba);
    }
