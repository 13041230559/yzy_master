...
public class PopUpView extends LinearLayout implements PopViewInterface {
    ...
    public PopUpView(Context context, AttributeSet attrs) {
        ...
        mContanierLl.setBackgroundResource(R.drawable.tan_chuang_liu);
        ...
        if (popItemAction.getStyle() == PopItemAction.PopItemStyle.Cancel) {
            if (mCancelItemView == null) {
                ...
                if (mIsShowCircleBackground) {
                    mCancelItemView.setBackgroundResource(R.drawable.tan_chuang_er);
                } else {
                    mCancelItemView.setBackgroundResource(R.drawable.tan_chuang_san);
                }
