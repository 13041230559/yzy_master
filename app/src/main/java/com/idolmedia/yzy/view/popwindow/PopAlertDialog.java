...
public class PopAlertDialog extends Dialog implements PopWindowInterface, DialogInterface.OnShowListener, View.OnClickListener,
    ...
    public PopAlertDialog(Activity activity, CharSequence title, CharSequence message, PopWindow popWindow) {
        ...
        setContentView(R.layout.tan_chuang_san);
    ...
    private void initAnim() {
        mPopOpenAnimation = AnimationUtils.loadAnimation(getContext(), R.anim.tanchuangwu);
        mPopCloseAnimation = AnimationUtils.loadAnimation(getContext(), R.anim.tanchuangliu);
        ...
        mAlphaOpenAnimation = AnimationUtils.loadAnimation(getContext(), R.anim.tanchuangqi);
        mAlphaCloseAnimation = AnimationUtils.loadAnimation(getContext(), R.anim.tanchuangba);
